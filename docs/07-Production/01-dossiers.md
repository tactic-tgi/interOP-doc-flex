...
Il est aussi possible de créer votre dossier à partir du [mode liste](../03-Fonctionnalités%20générales/02-navigation.md#mode-liste) du module Dossiers.
...
- [Quantités](../05-Estimation/01-soumissions.md#quantités)
- [Composantes](../05-Estimation/01-soumissions.md#composantes)
- [Opérations globales](../05-Estimation/01-soumissions.md#opérations-globales)
...
Il est possible de cliquez sur une opération pour modifier le temps réalisé ou pour Terminer l'opération. La [procédure](../07-Production/02-listesuivi.md) est la même que dans la **Liste de suivi.**

![](../../static/img/Dossiers_16.png)
...
![](../../static/img/Dossier_Prixderevient_03.png)
